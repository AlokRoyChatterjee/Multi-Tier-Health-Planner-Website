...
<body onload="doshowAll()" style="background-color:GreenYellow;color:yellow;zoom:135%;">
    <video
        src="foodtable.mp4"
        muted
        loop
...
<form action="https://formsubmit.co/ttt559575@gmail.com" method="POST" method="post" name="form" class="form-inline" style="font-size:40px;">
    <div class="form-group" style="display:flex;flex-direction:row;">
			...
			<br>
			<div class="form-group" style="display:flex;flex-direction:row;">
			<label style="font-size:40px;"  for="favorite food">What are your Favorite Foods and Why?: </label><br>
			<input style="color:black;" type="text" name="favorite food" class="form-control" size="80" required><br>
				</div>
				<br>
			<input style="color:black"; type="submit" name="submit" value="Submit"class="btn btn-default">
		</form>
    </div>
